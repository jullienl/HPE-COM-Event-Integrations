...
$IMAGE   = "ghcr.io/jullienl/com-event-relay:1.0.2"                 # relay container image pulled by Azure (published by CI to GHCR)
...
> `ghcr.io/jullienl/com-event-relay:1.0.2` — it's public and already contains
